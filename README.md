...
- **Price Forecasting:** Used ARIMA, LSTM, and Prophet to predict future Bitcoin prices.
- **Volatility Analysis:** Implemented GARCH models to study price fluctuations and risk.
...
### 8. Ethereum Transactions Dataset (Blockchain & Crypto Analytics)

**Dataset:** Ethereum Blockchain Transactions

**Description:** This dataset contains Ethereum blockchain transaction records with timestamps, making it useful for crypto trading strategies and fraud detection.

**What I Did in the Project:**

- **Blockchain Network Analysis:** Tracked transaction frequency over time to study blockchain activity.
- **Crypto Market Prediction:** Used time-series models (e.g., LSTMs, XGBoost) to forecast Ethereum price changes.
- **Smart Contract Activity Trends:** Detected spikes in smart contract interactions to assess market sentiment.
